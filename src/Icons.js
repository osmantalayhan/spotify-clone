const HomeIcon = ({ size }) => {
    return (
        <svg height={size} width={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="CurrentColor">
...
const PlusIcon = ({ size }) => {
    return (
        <svg height={size} width={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="CurrentColor">
...
const ExternalIcon = ({ size }) => {
    return (
        <svg height={size} width={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="CurrentColor">
            <path d="M1 2.75A.75.75 0 011.75 2H7v1.5H2.5v11h10.219V9h1.5v6.25a.75.75 0 01-.75.75H1.75a.75.75 0 01-.75-.75V2.75z"></path><path d="M15 1v4.993a.75.75 0 11-1.5 0V3.56L8.78 8.28a.75.75 0 01-1.06-1.06l4.72-4.72h-2.433a.75.75 0 010-1.5H15z"></path>
        </svg>
    )
}
...
const PlayIcon = ({ size }) => {
    return (
        <svg height={size} width={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="#000">
            <path d="M3 1.713a.7.7 0 011.05-.607l10.89 6.288a.7.7 0 010 1.212L4.05 14.894A.7.7 0 013 14.288V1.713z"></path>
        </svg>
    )
}

const PlayIcon2 = ({ size }) => {
    return (
        <svg height={size} width={size} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="CurrentColor">
            <path d="M3 1.713a.7.7 0 011.05-.607l10.89 6.288a.7.7 0 010 1.212L4.05 14.894A.7.7 0 013 14.288V1.713z"></path>
        </svg>
